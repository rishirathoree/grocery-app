  ...
  return (
    ...
    <div className='flex items-center lg:flex-row md:flex-row sm:flex-col sm:items-start justify-between gap-2 rounded-lg ring-1 p-4 ring-black/5'>
        <label htmlFor="order points" className='w-full'>
            <p className='font-semibold text-xsm'>Points</p>
        <input type="text" value={1} className='w-full p-2 bg-gray-100 outline-none focus:outline-none duration-500 hover:ring-green-300 hover:ring-1 hover:ring-black/5 text-xsm font-semibold' />
        </label>
        <label htmlFor="order points" className='w-full'>
            <p className='font-semibold text-xsm'>Order Amount</p>
        ...
        <label htmlFor="order points" className='w-full'>
            <p className='font-semibold text-xsm'>Valid From</p>
        <input type="text" className='w-full p-2 bg-gray-100 outline-none focus:outline-none duration-500 hover:ring-green-300 hover:ring-1 hover:ring-black/5 text-xsm font-semibold' />
        </label>
    ...
    <div>
        ...
        <div className='checkboxforStatus flex gap-2 items-center'>
                <span onClick={()=>{setStatusMode('Active')}} className={`font-semibold duration-500 cursor-pointer text-xsm bg-[#7bff95] p-2 px-6 text-white ${statusMode === 'Active' ? 'bg-green-700/80' : ''}`}>Active</span>
                <span onClick={()=>{setStatusMode('Inactive')}} className={`font-semibold duration-500 cursor-pointer text-xsm bg-[#7bff95] p-2 px-6 text-white ${statusMode === 'Inactive' ? 'bg-green-700/80' : ''}`}>Inactive</span>
        </div>
    </div>
...
export default AddNewConfigPoints