  ...
  return (
    ...
    <div>
        ...
        <div className='checkboxforStatus flex gap-2 items-center'>
                ...
                <span onClick={()=>{setStatusMode('Inactive')}} className={`font-semibold duration-500 cursor-pointer text-xsm bg-green-500 p-2 px-6 text-white ${statusMode === 'Inactive' ? 'bg-green-600' : ''}`}>Inactive</span>
        </div>
    </div>
