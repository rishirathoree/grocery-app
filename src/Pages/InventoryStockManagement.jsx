  ...
  return (
    ...
    <div className='p-4 space-y-6'>
        <div className='flex gap-4 flex-col'>
            ...
            <div onClick={()=>{setStockManageMent(!stockManageMent)}} className={`w-20 h-10 flex items-center justify-center rounded-full duration-1000 shadow ${stockManageMent ? 'bg-[#67dc7e]' : 'bg-red-500'}`}>
